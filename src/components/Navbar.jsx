    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-light shadow-sm sticky-top">
            <div className="container px-4 px-lg-5">
                {/* Logo: vuelve al inicio (tienda) */}
                <a 
                    className="navbar-brand fw-bold" 
                    href="#!" 
                    onClick={(e) => { e.preventDefault(); setView('tienda'); }}
                >
                    Carvelu
                </a>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu">
                                <li><a className="dropdown-item" href="#!" onClick={(e) => { e.preventDefault(); setView('tienda'); }}>Todos los productos</a></li>
                    ...
                    <div className="d-flex align-items-center gap-2">
                        ...
                        {/* Botón Carrito: cambia la vista a 'carrito' */}
                        <button 
